...
var x=['./components/common/load-more.wxml','./components/common/no-thing.wxml','./components/common/uploud-images.wxml','./components/index/index-list.wxml','./components/index/swiper-tab-head.wxml','./components/uni-icon/uni-icon.wxml','./components/uni-nav-bar/uni-nav-bar.wxml','./components/uni-popup/uni-popup.wxml','./components/uni-status-bar/uni-status-bar.wxml','./pages/add-input/add-input.wxml','./pages/demo/demo.wxml','./pages/home/home.wxml','./pages/index/index.wxml','./pages/news/news.wxml','./pages/paper/paper.wxml','./pages/search/search.wxml'];d_[x[0]]={}
...
var z=gz$gwx_10()
var hKD=_n('view')
var oLD=_mz(z,'uni-nav-bar',['bind:__l',0,'bind:clickLeft',1,'bind:clickRight',1,'data-event-opts',2,'leftIcon',3,'rightText',4,'statusBar',5,'vueId',6,'vueSlots',7],[],e,s,gg)
...
var tQD=_mz(z,'textarea',['bindinput',15,'data-event-opts',1,'placeholder',2,'value',3],[],e,s,gg)
_(aPD,tQD)
_(hKD,aPD)
var eRD=_mz(z,'uploud-images',['bind:__l',19,'bind:uploud',1,'data-event-opts',2,'vueId',3],[],e,s,gg)
_(hKD,eRD)
var bSD=_mz(z,'uni-popup',['bind:__l',23,'bind:hidePopup',1,'data-event-opts',2,'mode',3,'position',4,'show',5,'vueId',6,'vueSlots',7],[],e,s,gg)
var oTD=_n('view')
_rz(z,oTD,'class',31,e,s,gg)
var xUD=_n('view')
_rz(z,xUD,'class',32,e,s,gg)
var oVD=_mz(z,'image',['mode',33,'src',1],[],e,s,gg)
_(xUD,oVD)
_(oTD,xUD)
var fWD=_n('view')
...
_(l3D,a4D)
_(oTD,l3D)
var t5D=_mz(z,'button',['bindtap',39,'data-event-opts',1,'type',2],[],e,s,gg)
...
var z=gz$gwx_11()
var o8D=_n('view')
var x9D=_mz(z,'view',['class',0,'hoverClass',1],[],e,s,gg)
...
var z=gz$gwx_13()
var cEE=_n('view')
var oFE=_mz(z,'swiper-tab-head',['bind:__l',0,'bind:tabtap',1,'data-event-opts',1,'tabBars',2,'tabIndex',3,'vueId',4],[],e,s,gg)
_(cEE,oFE)
var lGE=_n('view')
_rz(z,lGE,'class',6,e,s,gg)
var aHE=_mz(z,'swiper',['bindchange',7,'class',1,'current',2,'data-event-opts',3,'style',4],[],e,s,gg)
var tIE=_v()
_(aHE,tIE)
var eJE=function(oLE,bKE,xME,gg){
var fOE=_n('swiper-item')
var cPE=_mz(z,'scroll-view',['scrollY',-1,'bindscrolltolower',16,'class',1,'data-event-opts',2],[],oLE,bKE,gg)
var hQE=_v()
_(cPE,hQE)
if(_oz(z,19,oLE,bKE,gg)){hQE.wxVkey=1
var oRE=_v()
_(hQE,oRE)
var cSE=function(lUE,oTE,aVE,gg){
var eXE=_mz(z,'index-list',['bind:__l',24,'index',1,'item',2,'vueId',3],[],lUE,oTE,gg)
_(aVE,eXE)
return aVE
}
oRE.wxXCkey=4
_2z(z,22,cSE,oLE,bKE,gg,oRE,'item','index1','index1')
var bYE=_mz(z,'load-more',['bind:__l',28,'loadtext',1,'vueId',2],[],oLE,bKE,gg)
_(hQE,bYE)
}
else{hQE.wxVkey=2
var oZE=_mz(z,'no-thing',['bind:__l',31,'vueId',1],[],oLE,bKE,gg)
_(hQE,oZE)
}
hQE.wxXCkey=1
hQE.wxXCkey=3
...
tIE.wxXCkey=4
_2z(z,14,eJE,e,s,gg,tIE,'items','index','index')
_(lGE,aHE)
_(cEE,lGE)
_(r,cEE)
return r
...
var z=gz$gwx_14()
var o2E=_n('view')
var f3E=_mz(z,'uni-nav-bar',['bind:__l',0,'bind:clickRight',1,'data-event-opts',1,'statusBar',2,'vueId',3,'vueSlots',4],[],e,s,gg)
var c4E=_n('view')
_rz(z,c4E,'slot',6,e,s,gg)
var h5E=_n('view')
...
var oDF=_mz(z,'view',['bindtap',14,'class',1,'data-event-opts',2],[],tAF,a0E,gg)
var oFF=_oz(z,17,tAF,a0E,gg)
_(oDF,oFF)
var xEF=_v()
_(oDF,xEF)
if(_oz(z,18,tAF,a0E,gg)){xEF.wxVkey=1
var fGF=_n('view')
_rz(z,fGF,'class',19,tAF,a0E,gg)
_(xEF,fGF)
}
xEF.wxXCkey=1
_(eBF,oDF)
...
o8E.wxXCkey=2
_2z(z,12,l9E,e,s,gg,o8E,'tab','index','id')
_(f3E,c7E)
var cHF=_n('view')
_rz(z,cHF,'slot',20,e,s,gg)
var hIF=_n('view')
